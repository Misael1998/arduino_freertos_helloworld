...
USR_DEFINED_TASKS := ./tasks
USR_DEFINED_INCLUDES := ./include
...
#User includes
INCLUDE_DIRS += -I${USR_DEFINED_INCLUDES}

#custom include directories
#INCLUDE_DIRS += -I${USR_DEFINED_TASKS}

SOURCE_FILES := $(wildcard *.c)
SOURCE_FILES += $(wildcard ${FREERTOS_DIR}/Source/*.c)

#User defined source files
SOURCE_FILES += $(wildcard ${USR_DEFINED_TASKS}/*.c)
